...
<%
	...
	if(id!=null)
	{
		if(id!="")
		{
			try
			{
				...
				if(match == true)
				{
					URL sqli_labs = new URL("http://localhost/sqli/Less-32/index.php?"+ qs);
	...
	{
		URL sqli_labs = new URL("http://localhost/sqli/Less-32/index.php");
        URLConnection sqli_labs_connection = sqli_labs.openConnection();
        BufferedReader in = new BufferedReader(
                                new InputStreamReader(
                                sqli_labs_connection.getInputStream()));
...
<font size='13' color= '#99FF00'>
<a href="http://localhost/waf/">WAF Bypass Main Menu </a> 
</font>
</center>
 </BODY> 
</html>
